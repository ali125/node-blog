...
$('[data-type="dropdown"]').each((i, el) => {
    ...
    if ($(`#${id}`)) {
        ...
        // $(`#${id}`).css({ left: $(el).offset().left, top: $(el).offset().top + $(el).outerHeight(), width: $(el).outerWidth() });
        $(el).on('click', () => {
            $(`#${id}`).slideToggle(300)
        });
    }
...
(() => {
    ...
    if (ctx && Chart) {
        const labels = ['January', 'Fabruary', 'March', 'April', 'Maay', 'June', 'July'];
        const data = {
            labels: labels,
            datasets: [
                {
                    label: 'Dataset 1',
                    data: [12, 8, 24, 4, 18, 20, 13],
                    borderColor: '#537bc4',
                ...
                {
                    label: 'Dataset 2',
                    data: [12, 8, 24, 4, 18, 20, 13].reverse(),
                    borderColor: '#acc236',
...
(() => {
    ...
    if (ctx && Chart) {
        const labels = ['ReactJS', 'NodeJs', 'Vanilla JS', 'NextJs', 'MongoDB', 'PostgreSQL', 'CSS', 'CSS Animation'];
        const data = {
            labels: labels,
            datasets: [
                {
                    label: 'Dataset 1',
                    data: [12, 8, 24, 4, 18, 20, 13, 10],
                    borderColor: '#537bc4',
                    backgroundColor: '#537bc4',
                },
                {
                    label: 'Dataset 2',
                    data: [12, 8, 24, 4, 18, 20, 13, 10].reverse(),
                    borderColor: '#acc236',
                    backgroundColor: '#acc236',
                }
            ]
