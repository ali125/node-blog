...
exports.dateToTimeAgo = exports.timeSince = exports.dateFormate = exports.dateTimeFormate = void 0;
const dateTimeFormate = (date = null, withTime = true) => {
    if (date === null)
        return '';
...
exports.dateTimeFormate = dateTimeFormate;
const dateFormate = (date = null, withTime = false) => {
    if (date === null)
        return '';
...
exports.dateToTimeAgo = dateToTimeAgo;
